...
import {tokenDuration,wordDuration} from './morse-engine.js?v=4';
...
const TIMING={
  afterFirstCw:.52,       // hear -> small breathing space
  afterVoice:.30,         // spoken answer -> short space
  betweenConfirmations:.16,
  beforeChime:.16,
  chimeDuration:.48,
  afterChime:.72,         // clear boundary before next character
  responseEarly:1.40,
  responseLater:1.12,
  revealTail:.25,
...
export async function buildLesson(lesson,{lang='es',gender='female',voice}={}){
  ...
  // -> polyphonic courtesy chime -> clear pause -> next character.
